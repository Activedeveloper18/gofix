...
simpleButton() {
  return ElevatedButton.styleFrom(
    padding: EdgeInsets.symmetric(vertical: 14, horizontal: 16), backgroundColor: appRed,
...
textInputDecoration(val) {
  return InputDecoration(
      labelText: '$val',
      labelStyle:
          TextStyle(color: Colors.grey, fontFamily: 'medium', fontSize: 14),
...
addButton() {
  return ElevatedButton.styleFrom(
    padding: EdgeInsets.symmetric(vertical: 8), backgroundColor: appRed,
    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(5)),
    elevation: 0,
    textStyle:
        TextStyle(fontFamily: 'medium', fontSize: 14, letterSpacing: 0.5),
  );
}
